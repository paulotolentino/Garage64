...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'apply_indexes') {
    ...
    $indexes = [
        ...
        'idx_miniatures_user'          => ['miniatures',       'CREATE INDEX idx_miniatures_user ON miniatures (user_id)'],
        'idx_categories_user'          => ['categories',       'CREATE INDEX idx_categories_user ON categories (user_id)'],
        'idx_tags_user'                => ['tags',             'CREATE INDEX idx_tags_user ON tags (user_id)'],
        'idx_wishlist_user'            => ['wishlist',         'CREATE INDEX idx_wishlist_user ON wishlist (user_id)'],
